    ...
    <?php
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            if(isset($_POST['tambah'])){
                ...
                $q = "INSERT INTO divisi (`nama_divisi`,`tunjangan`) VALUES ('$nama','$tunjangan')";
                $r = mysqli_query($con,$q);
                alert('success','Berhasil menambahkan data divisi');
            }
        }
        ...
        if (isset($_GET["action"]) && $_GET["action"] == "delete" && isset($_GET["id"])) {
            $id = $_GET["id"];
            $q = "DELETE FROM divisi WHERE id_divisi=$id";
            $r = mysqli_query($con, $q);
                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-4">
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Overview Divisi</h6>
                                    <button class="btn btn-primary" data-toggle="modal" data-target="#divisiModal">
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                $q = "SELECT * FROM divisi ORDER BY id_divisi ASC";
                                                $r = mysqli_query($con,$q);
                                                $i=1;
                                                if($r){
                                                    while($row = mysqli_fetch_assoc($r)){
                                                        ...
                                                        echo "<td><a href='edit_divisi.php?id=$row[id_divisi]' class='btn btn-sm btn-warning'>Edit</a>
                                                        <a href='divisi.php?action=delete&id={$row['id_divisi']}' class='btn btn-sm btn-danger'>Hapus</a></td>";
                                                        echo "</tr>";
                                                        $i++;
                                                    }
                                                }
