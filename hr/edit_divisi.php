...
<head>
    <?php
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $sql = "UPDATE divisi SET nama_divisi='$nama', tunjangan='$tunjangan' WHERE id_divisi='$id_divisi'";
                ...
                <div class="container-fluid">
                    ...
                    <form class="offset-md-1" method="POST">
                        ...
                        <div class="col-md-10 mb-3">
                            ...
                            <input type="text" value="<?php echo $dt['nama_divisi'] ?>" name="nama" class="form-control shadow-none" required>
                        </div>
                        <div class="col-md-10 mb-3">
                            <label class="form-label fw-bold">Tunjangan:</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">Rp.</span>
                                <input type="number" name="tunjangan" value="<?php echo $dt['tunjangan'] ?>" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-10">
                            <a href="divisi.php" class="btn btn-dark">Kembali</a>
