...
<head>
    <?php
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $sql = "UPDATE jabatan SET nama_jabatan='$nama', gaji_pokok='$gaji_pokok' WHERE id_jabatan='$id_jabatan'";
            $res = mysqli_query($con,$sql);
            redirect('jabatan.php');
        }
    ?>
    <meta charset="utf-8">
                ...
                <div class="container-fluid">
                    ...
                    <form class="offset-md-1" method="POST">
                        ...
                        <div class="col-md-10 mb-3">
                            ...
                            <input type="text" value="<?php echo $dt['nama_jabatan'] ?>" name="nama" class="form-control shadow-none" required>
                        </div>
                        <div class="col-md-10 mb-3">
                            <label class="form-label fw-bold">Gaji Pokok:</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">Rp.</span>
                                <input type="number" name="gaji_pokok" value="<?php echo $dt['gaji_pokok'] ?>" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-10">
                            <a href="jabatan.php" class="btn btn-dark">Kembali</a>
