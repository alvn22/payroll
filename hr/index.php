                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    $q = "select count(*) as total from karyawan";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    $q = "select count(*) as total from jabatan";
                                                    $r = mysqli_query($con, $q);
                                                    $dt = mysqli_fetch_assoc($r)
                                                ?>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $dt['total'] ?></div>
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Divisi</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    $q = "select count(*) as total from divisi";
                                                    $r = mysqli_query($con, $q);
                                                    $dt = mysqli_fetch_assoc($r)
                                                ?>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $dt['total'] ?></div>
